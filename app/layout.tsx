...
export const metadata: Metadata = {
  ...
  description:
    "Clean-sheet three-chamber dynamic release device for simultaneous drug-release kinetics and in-situ infection challenge. Design review by Filippo Fonseca for Dr. Mehmet D. Aşik (MGB / HOL / HMS).",
