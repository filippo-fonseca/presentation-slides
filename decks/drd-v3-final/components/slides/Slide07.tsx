...
const interfaces = [
  {
    ...
    body: "Six tweezer-latches hold the cartridge in the satellite; O-ring backs the seam.",
  },
  {
    n: "②",
    color: "chip-bacteria",
    ...
    title: "Lid → base",
    body: "Lid and base capture the membrane sandwich; O-ring closes the gap.",
  },
  {
    n: "③",
    ...
    title: "Satellite → hub",
    body: "Two C-ring wrappers latch closed around the joint; O-ring rides in the gland.",
  },
];
