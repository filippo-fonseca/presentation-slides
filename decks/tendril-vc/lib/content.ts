...
export const SCENES: ReadonlyArray<SceneMeta> = [
  ...
  { id: "small",     title: "Small and modular",   beats: 3 },
  { id: "lock-in",   title: "The lock-in tax",     beats: 2 },
  { id: "energy",    title: "Clean energy",        beats: 2 },
  { id: "different", title: "How we're different", beats: 3 },
  { id: "competition", title: "The closest comps", beats: 3 },
  ...
  { id: "validation", title: "In their own words", beats: 2 },
  { id: "safety",    title: "The human cost",      beats: 2 },
  { id: "onus",      title: "Their livelihood",    beats: 2 },
  { id: "stakes",    title: "The stakes",          beats: 3 },
