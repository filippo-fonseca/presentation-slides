...
export const SLIDES: SlideEntry[] = [
  ...
  {
    id: "clamp",
    title: "The four-screw clamp",
    sectionLabel: "Assembly / Bench Testing",
    Component: Slide08,
    notes:
      "Four M2.5 screws clamp each satellite to the hub through these flange arms, and the hub's interior wall is thickened for a watertight seat. The point is that this is a defined clamp — repeatable and removable — instead of relying on press-fitting parts into SLA prints, which is what bit us before.\n\nI think the screws are genuinely easy to use, but I'm open: there's a screwless quarter-turn version I could develop if you'd prefer fewer loose parts. Your call.",
  },
  {
    id: "assembly",
